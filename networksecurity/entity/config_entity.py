...
class TrainingPipelineConfig:
    def __init__(self, timestamp: datetime | None = None):
        ...
        formatted = current.strftime("%Y%m%dT%H%M%S.%fZ")
        self.pipeline_name = training_pipeline.PIPELINE_NAME
        self.artifact_name = training_pipeline.ARTIFACT_DIR
        self.artifact_dir = os.path.join(self.artifact_name, formatted)
        self.timestamp = formatted
...
class ModelTrainerConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.metadata_file_path = os.path.join(self.model_trainer_dir, "metadata.json")
        self.minimum_f1 = training_pipeline.MODEL_TRAINER_MIN_F1
